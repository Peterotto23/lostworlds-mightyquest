...
namespace Backend
{
    namespace Hero
    {
        ...
        struct Hero_t
        {
            ...
            MQEL_json Serialize()
            {
                ...
                if (Gear[(uint32_t)eItemslot::Head].ID)
                    Object["Equipment"]["Head"] =
                        Gear[(uint32_t)eItemslot::Head].Serialize();

                if (Gear[(uint32_t)eItemslot::Shoulders].ID)
                    Object["Equipment"]["Shoulders"] =
                        Gear[(uint32_t)eItemslot::Shoulders].Serialize();

                if (Gear[(uint32_t)eItemslot::Body].ID)
                    Object["Equipment"]["Body"] =
                        Gear[(uint32_t)eItemslot::Body].Serialize();

                if (Gear[(uint32_t)eItemslot::Back].ID)
                    Object["Equipment"]["Back"] =
                        Gear[(uint32_t)eItemslot::Back].Serialize();

                if (Gear[(uint32_t)eItemslot::Neck].ID)
                    Object["Equipment"]["Neck"] =
                        Gear[(uint32_t)eItemslot::Neck].Serialize();

                if (Gear[(uint32_t)eItemslot::Finger].ID)
                    Object["Equipment"]["Finger"] =
                        Gear[(uint32_t)eItemslot::Finger].Serialize();

                if (Gear[(uint32_t)eItemslot::Hands].ID)
                    Object["Equipment"]["Hands"] =
                        Gear[(uint32_t)eItemslot::Hands].Serialize();

                if (Gear[(uint32_t)eItemslot::Mainhand].ID)
                    Object["Equipment"]["MainHand"] =
                        Gear[(uint32_t)eItemslot::Mainhand].Serialize();

                if (Gear[(uint32_t)eItemslot::Offhand].ID)
                    Object["Equipment"]["OffHand"] =
                        Gear[(uint32_t)eItemslot::Offhand].Serialize();

                if (Gear[(uint32_t)eItemslot::Costume].ID)
                    Object["Equipment"]["Costume"] =
                        Gear[(uint32_t)eItemslot::Costume].Serialize();

                if (Gear[(uint32_t)eItemslot::Pet].ID)
                    Object["Equipment"]["Pet"] =
                        Gear[(uint32_t)eItemslot::Pet].Serialize();

                // Game-assigned equipment.
                for (auto &Item : Spells)
                    Object["EquippedSpells"] += Item.Serialize();

                for (auto &Item : Consumables)
                    Object["EquippedConsumables"] += Item.Serialize();

                // Semi-public statistics.
                Object["Stats"] = Stats.Serialize();

                for (auto &Item : Knownregions)
                    Object["AttackRegions"] += Item.Serialize();
            ...
            {
                // Core data.
                if (!Object["HeroSpecContainerId"].is_null())
                {
                    Type =
                        (eHerotype)Object["HeroSpecContainerId"].get<uint32_t>();
                }

                if (!Object["Level"].is_null())
                {
                    Level = Object["Level"];
                }

                if (!Object["XP"].is_null())
                {
                    TotalXP = Object["XP"];
                }

                // User-modifiable equipment.
                if (!Object["Equipment"]["Head"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Head].Deserialize(
                        Object["Equipment"]["Head"]);
                }

                if (!Object["Equipment"]["Shoulders"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Shoulders].Deserialize(
                        Object["Equipment"]["Shoulders"]);
                }

                if (!Object["Equipment"]["Body"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Body].Deserialize(
                        Object["Equipment"]["Body"]);
                }

                if (!Object["Equipment"]["Back"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Back].Deserialize(
                        Object["Equipment"]["Back"]);
                }

                if (!Object["Equipment"]["Neck"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Neck].Deserialize(
                        Object["Equipment"]["Neck"]);
                }

                if (!Object["Equipment"]["Finger"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Finger].Deserialize(
                        Object["Equipment"]["Finger"]);
                }

                if (!Object["Equipment"]["Hands"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Hands].Deserialize(
                        Object["Equipment"]["Hands"]);
                }

                if (!Object["Equipment"]["MainHand"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Mainhand].Deserialize(
                        Object["Equipment"]["MainHand"]);
                }

                if (!Object["Equipment"]["OffHand"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Offhand].Deserialize(
                        Object["Equipment"]["OffHand"]);
                }

                if (!Object["Equipment"]["Costume"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Costume].Deserialize(
                        Object["Equipment"]["Costume"]);
                }

                if (!Object["Equipment"]["Pet"].is_null())
                {
                    Gear[(uint32_t)eItemslot::Pet].Deserialize(
                        Object["Equipment"]["Pet"]);
                }
                ...
                // Semi-public statistics.
                if (!Object["Stats"].is_null())
                {
                    Stats.Deserialize(Object["Stats"]);
                }
                ...
                if (!Object["AttackRegions"].is_null())
                {
                    ...
                    {
                        Knownregions.push_back(
                            {Item["AttackRegionId"],
                             (eRegionstatus)Item["Status"].get<uint32_t>()});
                    }
                }
            }
        };
        ...
        void NotifyXPChange(uint32_t XPIncrease, uint32_t Class)
        {
            ...
            Notification["$type"] =
                "HyperQuest.GameServer.Contracts.HeroXpChangedNotification, "
                "HyperQuest.GameServer.Contracts";

            Notification["HeroSpecContainerId"] =
                (uint32_t)Heroes[Class].Type;
        ...
        void Createhero(int Class)
        {
            ...
            Currenthero->Knownregions.push_back(
                {1, eRegionstatus::Unlocked});
        }
        ...
        template <>
        MQEL_json Serialize(int Class)
        {
            return Heroes[Class].Serialize();
        }

        template <typename C>
        MQEL_json Serialize(C Class)
        {
            return Serialize((int)Class);
        }

        // Modify the character's XP.
        template <>
        void IncreaseXP(uint32_t XP, int Class)
        {
        ...
        template <>
        void IncreaseXP(uint32_t XP, eHerotype Class)
        {
            return IncreaseXP(XP, (int)Class);
        }

        // Set the character's XP without generating
        ...
        template <>
        void SetXP(uint32_t XP, eHerotype Class)
        {
            return SetXP(XP, (int)Class);
        }

        // Modify the character's statistics.
        template <>
        void Increasestats(Stat_t Delta, int Class)
        {
            Heroes[Class].Stats.Creatureskilled +=
                Delta.Creatureskilled;

            Heroes[Class].Stats.Castleslooted +=
                Delta.Castleslooted;

            Heroes[Class].Stats.Timesplayed +=
                Delta.Timesplayed;
        }

        template <>
        void Increasestats(Stat_t Delta, eHerotype Class)
        {
        ...
        template <>
        void Increaselevel(uint32_t Level, int Class)
        {
            Heroes[Class].Level += Level;
        }

        template <>
        void Increaselevel(uint32_t Level, eHerotype Class)
        {
            return Increaselevel(Level, (int)Class);
        }

        // Modify the character's equipment.
        template <>
        void Equipspell(Spell_t Spell, int Class)
        {
            // Remove any old instance of the spell.
            for (auto Iterator = Heroes[Class].Spells.begin();
                 Iterator != Heroes[Class].Spells.end();
                 ++Iterator)
            {
        ...
        template <>
        void Equipspell(Spell_t Spell, eHerotype Class)
        {
        ...
        template <>
        void Equipgear(eItemslot Slot, Equipment_t Item, int Class)
        {
            return Equipgear((int)Slot, Item, Class);
        }

        template <>
        void Equipgear(int Slot, Equipment_t Item, eHerotype Class)
        {
            return Equipgear(Slot, Item, (int)Class);
        }

        template <>
        void Equipgear(eItemslot Slot, Equipment_t Item, eHerotype Class)
        {
        ...
        void Loadhero()
        {
            ...
            try
            {
                ...
                if (!Object["Mage"].is_null())
                {
                    Heroes[(size_t)eHerotype::Mage].Deserialize(
                        Object["Mage"]);
                }

                if (!Object["Knight"].is_null())
                {
                    Heroes[(size_t)eHerotype::Knight].Deserialize(
                        Object["Knight"]);
                }

                if (!Object["Archer"].is_null())
                {
                    Heroes[(size_t)eHerotype::Archer].Deserialize(
                        Object["Archer"]);
                }

                if (!Object["Runaway"].is_null())
                {
                    Heroes[(size_t)eHerotype::Runaway].Deserialize(
                        Object["Runaway"]);
                }
                ...
                else
                {
                    ...
                    {
                        Currenthero =
                            &Heroes[(size_t)eHerotype::Mage];
                    }
                    else if (!Object["Knight"].is_null())
                    {
                        Currenthero =
                            &Heroes[(size_t)eHerotype::Knight];
                    }
                    else if (!Object["Archer"].is_null())
                    {
                        Currenthero =
                            &Heroes[(size_t)eHerotype::Archer];
                    }
                    else if (!Object["Runaway"].is_null())
                    {
                        Currenthero =
                            &Heroes[(size_t)eHerotype::Runaway];
                    }
